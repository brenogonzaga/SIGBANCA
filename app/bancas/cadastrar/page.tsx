...
export default function CadastrarBancaPage() {
  ...
  const trabalhoId = searchParams.get("trabalhoId") ?? undefined;
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-black text-[var(--foreground)] tracking-tight mb-4">
              Agendar{" "}
              <span className="bg-gradient-to-r from-[var(--primary)] to-[#7C3AED] bg-clip-text text-transparent italic">
                Avaliação
              </span>
            </h1>
            <p className="text-[var(--muted)] text-lg font-medium max-w-2xl mx-auto">
              Defina a data, local e os membros que participarão da banca examinadora do
              trabalho acadêmico.
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 -mt-12 pb-20 relative z-20">
        <div className="max-w-4xl mx-auto">
          <div className="overflow-hidden">
            <BancaForm trabalhoIdInicial={trabalhoId} />
          </div>
        </div>
      </div>
    </div>
