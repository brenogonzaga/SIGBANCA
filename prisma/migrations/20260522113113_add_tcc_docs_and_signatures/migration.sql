...
-- AddForeignKey
ALTER TABLE "autorizacoes_publicacao" ADD CONSTRAINT "autorizacoes_publicacao_trabalhoId_fkey" FOREIGN KEY ("trabalhoId") REFERENCES "trabalhos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
